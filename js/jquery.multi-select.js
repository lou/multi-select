    ...
    MultiSelect.prototype = {
        ...
        'generateLisFromOption': function (option, index, $container) {
            ...
            var selectableLi = $('<li ' + attributes + '><span>' + that.escapeHTML($option.text()) + '</span></li>'),
                ...
                value = $option.val(),
                elementId = that.sanitize();

            option.id = elementId;
            selectableLi.data('ms-value', elementId).addClass('ms-elem-selectable').attr('id', elementId + '-selectable');

            selectedLi.data('ms-value', elementId).addClass('ms-elem-selection').attr('id', elementId + '-selection').hide();
        ...
        'select': function (value, method) {
            ...
            var that = this,
                ...
                options = ms.find('option:not(:disabled)').filter(function () {
                    return ($.inArray(this.id, value) > -1);
                });
